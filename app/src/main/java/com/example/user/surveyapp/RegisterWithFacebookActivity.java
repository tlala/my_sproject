 ...
 */
public class RegisterWithFacebookActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.register_with_facebook_layout);
            ...
            public void onClick(View v) {
                ...
                if(isLegalUsername(username)) {
                   ...
                   // Boolean isValidUsername = Boolean.parseBoolean(xmlReader.getElementContentByName("IsValidUsername"));
                    ...
                    //    snackbar.show();
                    //} else {
                        FacebookLogingManagement.CreateNewFacebookUser(username,AccessToken.getCurrentAccessToken());
                        startActivity(new Intent(RegisterWithFacebookActivity.this, MainAppActivity.class));
                    //}
                }
